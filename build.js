...
System.register("npm:react@0.10.0/lib/copyProperties", [], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";function copyProperties(e,t,n,r,o,a,i){if(e=e||{},"production"!==process.env.NODE_ENV&&i)throw new Error("Too many arguments passed to copyProperties");for(var s,c=[t,n,r,o,a],u=0;c[u];){s=c[u++];for(var p in s)e[p]=s[p];s.hasOwnProperty&&s.hasOwnProperty("toString")&&"undefined"!=typeof s.toString&&e.toString!==s.toString&&(e.toString=s.toString)}return e}module.exports=copyProperties;
...
System.register("npm:react@0.10.0/lib/CSSProperty", [], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";function prefixKey(e,s){return e+s.charAt(0).toUpperCase()+s.substring(1)}var isUnitlessNumber={columnCount:!0,fillOpacity:!0,flex:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},prefixes=["Webkit","ms","Moz","O"];Object.keys(isUnitlessNumber).forEach(function(e){prefixes.forEach(function(s){isUnitlessNumber[prefixKey(s,e)]=isUnitlessNumber[e]})});var shorthandPropertyExpansions={background:{backgroundImage:!0,backgroundPosition:!0,backgroundRepeat:!0,backgroundColor:!0},border:{borderWidth:!0,borderStyle:!0,borderColor:!0},borderBottom:{borderBottomWidth:!0,borderBottomStyle:!0,borderBottomColor:!0},borderLeft:{borderLeftWidth:!0,borderLeftStyle:!0,borderLeftColor:!0},borderRight:{borderRightWidth:!0,borderRightStyle:!0,borderRightColor:!0},borderTop:{borderTopWidth:!0,borderTopStyle:!0,borderTopColor:!0},font:{fontStyle:!0,fontVariant:!0,fontWeight:!0,fontSize:!0,lineHeight:!0,fontFamily:!0}},CSSProperty={isUnitlessNumber:isUnitlessNumber,shorthandPropertyExpansions:shorthandPropertyExpansions};module.exports=CSSProperty;
...
System.register("npm:react@0.10.0/lib/Transaction", ["./invariant"], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";var invariant=require("./invariant"),Mixin={reinitializeTransaction:function(){this.transactionWrappers=this.getTransactionWrappers(),this.wrapperInitData?this.wrapperInitData.length=0:this.wrapperInitData=[],this.timingMetrics||(this.timingMetrics={}),this.timingMetrics.methodInvocationTime=0,this.timingMetrics.wrapperInitTimes?this.timingMetrics.wrapperInitTimes.length=0:this.timingMetrics.wrapperInitTimes=[],this.timingMetrics.wrapperCloseTimes?this.timingMetrics.wrapperCloseTimes.length=0:this.timingMetrics.wrapperCloseTimes=[],this._isInTransaction=!1},_isInTransaction:!1,getTransactionWrappers:null,isInTransaction:function(){return!!this._isInTransaction},perform:function(e,t,n,o,r,a,i,s){"production"!==process.env.NODE_ENV?invariant(!this.isInTransaction(),"Transaction.perform(...): Cannot initialize a transaction when there is already an outstanding transaction."):invariant(!this.isInTransaction());var c,u,p=Date.now();try{this._isInTransaction=!0,c=!0,this.initializeAll(0),u=e.call(t,n,o,r,a,i,s),c=!1}finally{var l=Date.now();this.methodInvocationTime+=l-p;try{if(c)try{this.closeAll(0)}catch(d){}else this.closeAll(0)}finally{this._isInTransaction=!1}}return u},initializeAll:function(e){for(var t=this.transactionWrappers,n=this.timingMetrics.wrapperInitTimes,o=e;o<t.length;o++){var r=Date.now(),a=t[o];try{this.wrapperInitData[o]=Transaction.OBSERVED_ERROR,this.wrapperInitData[o]=a.initialize?a.initialize.call(this):null}finally{var i=n[o],s=Date.now();if(n[o]=(i||0)+(s-r),this.wrapperInitData[o]===Transaction.OBSERVED_ERROR)try{this.initializeAll(o+1)}catch(c){}}}},closeAll:function(e){"production"!==process.env.NODE_ENV?invariant(this.isInTransaction(),"Transaction.closeAll(): Cannot close transaction when none are open."):invariant(this.isInTransaction());for(var t=this.transactionWrappers,n=this.timingMetrics.wrapperCloseTimes,o=e;o<t.length;o++){var r,a=t[o],i=Date.now(),s=this.wrapperInitData[o];try{r=!0,s!==Transaction.OBSERVED_ERROR&&a.close&&a.close.call(this,s),r=!1}finally{var c=Date.now(),u=n[o];if(n[o]=(u||0)+(c-i),r)try{this.closeAll(o+1)}catch(p){}}}this.wrapperInitData.length=0}},Transaction={Mixin:Mixin,OBSERVED_ERROR:{}};module.exports=Transaction;
...
System.register("npm:react@0.10.0/lib/CSSPropertyOperations", ["./CSSProperty","./dangerousStyleValue","./escapeTextForBrowser","./hyphenate","./memoizeStringOnly"], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";var CSSProperty=require("./CSSProperty"),dangerousStyleValue=require("./dangerousStyleValue"),escapeTextForBrowser=require("./escapeTextForBrowser"),hyphenate=require("./hyphenate"),memoizeStringOnly=require("./memoizeStringOnly"),processStyleName=memoizeStringOnly(function(e){return escapeTextForBrowser(hyphenate(e))}),CSSPropertyOperations={createMarkupForStyles:function(e){var r="";for(var s in e)if(e.hasOwnProperty(s)){var o=e[s];null!=o&&(r+=processStyleName(s)+":",r+=dangerousStyleValue(s,o)+";")}return r||null},setValueForStyles:function(e,r){var s=e.style;for(var o in r)if(r.hasOwnProperty(o)){var t=dangerousStyleValue(o,r[o]);if(t)s[o]=t;else{var a=CSSProperty.shorthandPropertyExpansions[o];if(a)for(var n in a)s[n]="";else s[o]=""}}}};module.exports=CSSPropertyOperations;
...
System.register("npm:react@0.10.0/lib/ReactDOMSelection", ["./getNodeForCharacterOffset","./getTextContentAccessor"], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";function getIEOffsets(e){var t=document.selection,n=t.createRange(),o=n.text.length,r=n.duplicate();r.moveToElementText(e),r.setEndPoint("EndToStart",n);var i=r.text.length,a=i+o;return{start:i,end:a}}function getModernOffsets(e){var t=window.getSelection();if(0===t.rangeCount)return null;var n=t.anchorNode,o=t.anchorOffset,r=t.focusNode,i=t.focusOffset,a=t.getRangeAt(0),s=a.toString().length,u=a.cloneRange();u.selectNodeContents(e),u.setEnd(a.startContainer,a.startOffset);var c=u.toString().length,p=c+s,l=document.createRange();l.setStart(n,o),l.setEnd(r,i);var d=l.collapsed;return l.detach(),{start:d?p:c,end:d?c:p}}function setIEOffsets(e,t){var n,o,r=document.selection.createRange().duplicate();"undefined"==typeof t.end?(n=t.start,o=n):t.start>t.end?(n=t.end,o=t.start):(n=t.start,o=t.end),r.moveToElementText(e),r.moveStart("character",n),r.setEndPoint("EndToStart",r),r.moveEnd("character",o-n),r.select()}function setModernOffsets(e,t){var n=window.getSelection(),o=e[getTextContentAccessor()].length,r=Math.min(t.start,o),i="undefined"==typeof t.end?r:Math.min(t.end,o);if(!n.extend&&r>i){var a=i;i=r,r=a}var s=getNodeForCharacterOffset(e,r),u=getNodeForCharacterOffset(e,i);if(s&&u){var c=document.createRange();c.setStart(s.node,s.offset),n.removeAllRanges(),r>i?(n.addRange(c),n.extend(u.node,u.offset)):(c.setEnd(u.node,u.offset),n.addRange(c)),c.detach()}}var getNodeForCharacterOffset=require("./getNodeForCharacterOffset"),getTextContentAccessor=require("./getTextContentAccessor"),ReactDOMSelection={getOffsets:function(e){var t=document.selection?getIEOffsets:getModernOffsets;return t(e)},setOffsets:function(e,t){var n=document.selection?setIEOffsets:setModernOffsets;n(e,t)}};module.exports=ReactDOMSelection;
...
System.register("npm:react@0.10.0/lib/DOMPropertyOperations", ["./DOMProperty","./escapeTextForBrowser","./memoizeStringOnly","./warning"], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";function shouldIgnoreValue(e,t){return null==t||DOMProperty.hasBooleanValue[e]&&!t||DOMProperty.hasPositiveNumericValue[e]&&(isNaN(t)||1>t)}var DOMProperty=require("./DOMProperty"),escapeTextForBrowser=require("./escapeTextForBrowser"),memoizeStringOnly=require("./memoizeStringOnly"),warning=require("./warning"),processAttributeNameAndPrefix=memoizeStringOnly(function(e){return escapeTextForBrowser(e)+'="'});if("production"!==process.env.NODE_ENV)var reactProps={children:!0,dangerouslySetInnerHTML:!0,key:!0,ref:!0},warnedProperties={},warnUnknownProperty=function(e){if(!reactProps[e]&&!warnedProperties[e]){warnedProperties[e]=!0;var t=e.toLowerCase(),o=DOMProperty.isCustomAttribute(t)?t:DOMProperty.getPossibleStandardName[t];"production"!==process.env.NODE_ENV?warning(null==o,"Unknown DOM property "+e+". Did you mean "+o+"?"):null}};var DOMPropertyOperations={createMarkupForID:function(e){return processAttributeNameAndPrefix(DOMProperty.ID_ATTRIBUTE_NAME)+escapeTextForBrowser(e)+'"'},createMarkupForProperty:function(e,t){if(DOMProperty.isStandardName[e]){if(shouldIgnoreValue(e,t))return"";var o=DOMProperty.getAttributeName[e];return DOMProperty.hasBooleanValue[e]?escapeTextForBrowser(o):processAttributeNameAndPrefix(o)+escapeTextForBrowser(t)+'"'}return DOMProperty.isCustomAttribute(e)?null==t?"":processAttributeNameAndPrefix(e)+escapeTextForBrowser(t)+'"':("production"!==process.env.NODE_ENV&&warnUnknownProperty(e),null)},setValueForProperty:function(e,t,o){if(DOMProperty.isStandardName[t]){var r=DOMProperty.getMutationMethod[t];if(r)r(e,o);else if(shouldIgnoreValue(t,o))this.deleteValueForProperty(e,t);else if(DOMProperty.mustUseAttribute[t])e.setAttribute(DOMProperty.getAttributeName[t],""+o);else{var n=DOMProperty.getPropertyName[t];DOMProperty.hasSideEffects[t]&&e[n]===o||(e[n]=o)}}else DOMProperty.isCustomAttribute(t)?null==o?e.removeAttribute(DOMProperty.getAttributeName[t]):e.setAttribute(t,""+o):"production"!==process.env.NODE_ENV&&warnUnknownProperty(t)},deleteValueForProperty:function(e,t){if(DOMProperty.isStandardName[t]){var o=DOMProperty.getMutationMethod[t];if(o)o(e,void 0);else if(DOMProperty.mustUseAttribute[t])e.removeAttribute(DOMProperty.getAttributeName[t]);else{var r=DOMProperty.getPropertyName[t],n=DOMProperty.getDefaultValueForProperty(e.nodeName,r);DOMProperty.hasSideEffects[t]&&e[r]===n||(e[r]=n)}}else DOMProperty.isCustomAttribute(t)?e.removeAttribute(t):"production"!==process.env.NODE_ENV&&warnUnknownProperty(t)}};module.exports=DOMPropertyOperations;
...
System.register("npm:react@0.10.0/lib/ReactTextComponent", ["./DOMPropertyOperations","./ReactBrowserComponentMixin","./ReactComponent","./escapeTextForBrowser","./mixInto"], true, function(require, exports, __moduleName) {
  ...
  var process = System.get("@@nodeProcess")["default"];
    ...
    var __dirname = "jspm_packages/npm/react@0.10.0/lib";
  "format cjs";"use strict";var DOMPropertyOperations=require("./DOMPropertyOperations"),ReactBrowserComponentMixin=require("./ReactBrowserComponentMixin"),ReactComponent=require("./ReactComponent"),escapeTextForBrowser=require("./escapeTextForBrowser"),mixInto=require("./mixInto"),ReactTextComponent=function(e){this.construct({text:e})};ReactTextComponent.ConvenienceConstructor=function(e){return new ReactTextComponent(e.text)},mixInto(ReactTextComponent,ReactComponent.Mixin),mixInto(ReactTextComponent,ReactBrowserComponentMixin),mixInto(ReactTextComponent,{mountComponent:function(e,t,n){ReactComponent.Mixin.mountComponent.call(this,e,t,n);var o=escapeTextForBrowser(this.props.text);return t.renderToStaticMarkup?o:"<span "+DOMPropertyOperations.createMarkupForID(e)+">"+o+"</span>"},receiveComponent:function(e){var t=e.props;t.text!==this.props.text&&(this.props.text=t.text,ReactComponent.BackendIDOperations.updateTextContentByID(this._rootNodeID,t.text))}}),ReactTextComponent.type=ReactTextComponent,ReactTextComponent.prototype.type=ReactTextComponent,module.exports=ReactTextComponent;
